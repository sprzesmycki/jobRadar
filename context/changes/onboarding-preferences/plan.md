...
- [x] 1.5 A logged-in user can save preferences without an RLS error — cfe423c
- [x] 1.6 A logged-in user can save a job status without an RLS error — cfe423c
...
- [x] 2.8 The dashboard remains usable on a mobile-width viewport — 09894c7
